 ...
 */
final class Version20240315091007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE frais_envoie (id INT AUTO_INCREMENT NOT NULL, frais_natiion DOUBLE PRECISION NOT NULL, frais_inter DOUBLE PRECISION NOT NULL, agence VARCHAR(50) NOT NULL, creer_le DATETIME NOT NULL, actif TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE partenaire (id INT AUTO_INCREMENT NOT NULL, commission_nation DOUBLE PRECISION NOT NULL, commission_inter DOUBLE PRECISION NOT NULL, creer_le DATETIME NOT NULL, actif TINYINT(1) NOT NULL, agence VARCHAR(50) NOT NULL, rattacher_a VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE frais_envoie');
